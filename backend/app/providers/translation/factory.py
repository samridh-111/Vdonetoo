...
@lru_cache
def get_translation_provider(name: Literal["openai", "gemini", "mymemory"]) -> TranslationProvider:
    ...
    if name == "mymemory":
        return MyMemoryTranslationProvider(contact_email=settings.mymemory_contact_email)
